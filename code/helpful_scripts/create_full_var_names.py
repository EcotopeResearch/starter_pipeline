...
with open(output_file, 'w', newline='') as csvfile:
    ...
    fieldnames = ["variable_alias","variable_name","pretty_name","descr","data_type","graph_id","secondary_axis","color","low_alarm","high_alarm","fault_time","timeframe","alarm_priority","changepoint","ffill_length","lower_bound","upper_bound","system","summary_group"]  # Get the header from the input CSV
